'''
ou are given a 0-indexed string s consisting of only lowercase English letters, 
...
of the ith letter is distance[i]. 
    ...
    def checkDistances(self, s: str, distance: list[int]) -> bool:
        ...
        for idx, ch in enumerate(s):
            ...
            if ch in first_index:
                if idx - first_index[ch] - 1 != distance[position]:
                    return False
            else:
                first_index[ch] = idx
